let targetTexts = ['If Dave earned more money, he would not leave California', 'If it were a foggy day, the fog would drift into the bay', "If his salary weren't so low, Dave wouldn't look for a new job"];
